...
class TassiliCreator extends Command
{
    ...
    public function handle()
    {
        ...
        $sourcePath = base_path('vendor/tassili/admin/Fichiers/PhpFiles');
        ...
        // ----- SECTION 1 -----
        $sourcePath3 = base_path('vendor/tassili/admin/Fichiers/TassiliPages1');
        ...
        // ----- ROUTES -----
        $sourcePath1 = base_path('vendor/tassili/admin/Fichiers/RouteFiles/tassili.php');
        ...
        // ----- SECTION 2 -----
        $sourcePath4 = base_path('vendor/tassili/admin/Fichiers/TassiliLibs1');
        ...
        // ----- SECTION 3 -----
        $sourcePath5 = base_path('vendor/tassili/admin/Fichiers/TassiliDev1');
        ...
        // ----- MIDDLEWARE -----
        $sourcePath6 = base_path('vendor/tassili/admin/Fichiers/MiddlewareFiles/TassiliAuth.php');
